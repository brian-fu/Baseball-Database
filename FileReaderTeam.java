    ...
    public static HashMap<Integer, Team> reader(HashMap<Integer, Player> players, String teamsFile) {
        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                int gamesPlayed = Integer.parseInt(teamInfo[2].trim());
                int wins = Integer.parseInt(teamInfo[3].trim());
                int losses = Integer.parseInt(teamInfo[4].trim());
                int runsScored = Integer.parseInt(teamInfo[5].trim());
                int runsAgainst = Integer.parseInt(teamInfo[6].trim());
                int runDifferential = Integer.parseInt(teamInfo[7].trim());
                double winningPercentage = Double.parseDouble(teamInfo[8].trim());
