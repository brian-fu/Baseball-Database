    ...
    public static HashMap<Integer, Team> reader(HashMap<Integer, Player> players, String teamsFile) {
        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                double winningPercentage = Double.parseDouble(teamInfo[2].trim());
                ...
                int currentStreak = Integer.parseInt(teamInfo[9].trim());
                ...
                Team team = new Team(teamRoster, teamID, teamName, gamesPlayed, wins, losses, winningPercentage, runsScored, runsAgainst, runDifferential, currentStreak);
